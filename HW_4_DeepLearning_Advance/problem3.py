...
def tanh(z):
    ...
    z_bound = 89.  # point not encountered any error for hyperbolic tangent
    z = z.clone()
    z[z >= z_bound] = 88.
    z[z <= -z_bound] = -88.
...
class RNN(sr):
    ...
    def __init__(self, p, h=10, c=10):
        ...
        # Weight Matrix U, Weight matrix V, and bias vector
    ...
    def forward(self, x, H):
        ...
        #########################################
        # INSERT YOUR CODE HERE
        H_new = tanh(H.mm(self.V) + x.mm(self.U) + self.b_h)

...
def compute_a1(z1):
    ...
    # Loop through the vecotr and compute the sigmoid activation a1
    a1 = np.asmatrix(np.empty((z1.shape[0], 1)))
...
def train(X, Y, h=3, alpha=0.01, n_epoch=100):
    ...
    for _ in range(n_epoch):
        ...
        for x, y in zip(X, Y):
            ...
            b2 = sr.update_b(b2, dL_dW2, alpha)
            #########################################
    return W1, b1, W2, b2
